# Walkthrough: template_conjoint_buttons
#
# Choice-based-conjoint survey (button version). Full flow:
...
# reveals fav_fruit when like_fruit is yes/kind_of. We answer so as to reach the
# normal end. CBC options are rich HTML/image button labels -> click by value.
